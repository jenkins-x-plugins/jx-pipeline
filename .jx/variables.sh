...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-pipeline/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-pipeline:0.1.51'
