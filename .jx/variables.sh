...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-pipeline/main/16'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-pipeline:0.3.2'
...
export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/go/bin:/usr/local/go/bin:/workspace/source/bin
